...
class PositionalList(_DoublyLinkedBase):
    ...
    class Position:
        ...
        def element(self):
            """
            Restituisce l'elemento memoorizzato in questa posizione
        ...
        def __ne__(self, other):
            """
            Restituisce Tru se 'other' non rappresenta la stessa posizione
    ...
    def _make_position(self, node):
        """
        Restituisce l'istanza di Position per il nodo dato(o None se è un nod sentinella)
    ...
    def last(self):
        """
        Restituisce l'ultima Position nella lista (None se è vuota).
    ...
    def before(self, p):
        """
        Restituisce l<a Position prima della Position p(None se la lista è vuota).
    ...
    def __iter__(self):
        ...
        while cursor is not None:
            ...
            cursorr = self.after(cursor)

    # --------------------------- mutatori -------------------------------------

    def _insert_between(self, e, predecessor, successor):
        """
        Aggiunge un elemento 'e' tra i nodi esistenti e restituisce Position.
    ...
    def add_first(self, e):
        """
        Aggiunge l'elemento 'e' all'inizio della lista e restituisce Position.
    ...
    def add_last(self, e):
        """
        Aggiunge l'elemento 'e' alla fine  della lista e restituisce Position.
    ...
    def add_before(self, p, e):
        """
        Inesrisce l'emento 'e' nella lista dopo la Position 'p' e restituisce la nuova Position.
    ...
    def add_after(self, p, e):
        """
        Inesrisce l'emento 'e' nella lista prima della Position 'p' e restituisce la nuova Position.
    ...
    def get_element(self, p):
        """
          Restituisce l'elemento in Position p.
    ...
    def replace(self, p, e):
        """
        Sostituisce l'elemnto nella Position 'p' con l'elemneto 'e'

        Restituisce l'elemnto precedentemente in Position 'p' (l'elemento sostituito)
