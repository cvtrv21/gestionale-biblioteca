class _DoublyLinkedBase:
    """
    Una classe base che fornisce una rappresentazione di lista
    ...
    class _Node:
        """
        Classe leggera, non pubblica per la memorizzazione
        di un nodo collegato singolarmente
        """
    ...
    def _insert_between(self, e, predecessor, successor):
        """
        Aggiunge l'elemento 'e' tra due nodi esistenti
        e restituisce un nuovo nodo
        """
